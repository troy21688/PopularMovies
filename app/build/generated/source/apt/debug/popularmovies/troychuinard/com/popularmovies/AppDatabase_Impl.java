  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `Movie` (`vote_count` INTEGER NOT NULL, `id` INTEGER NOT NULL, `video` INTEGER NOT NULL, `title` TEXT, `popularity` REAL NOT NULL, `poster_path` TEXT, `original_language` TEXT, `original_title` TEXT, `genre_ids` TEXT, `backdrop_path` TEXT, `adult` INTEGER NOT NULL, `overview` TEXT, `release_date` TEXT, `vote_average` TEXT, PRIMARY KEY(`id`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"36004f94f87652e39062588270c0c9f4\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        _columnsMovie.put("genre_ids", new TableInfo.Column("genre_ids", "TEXT", false, 0));
    ...
    }, "36004f94f87652e39062588270c0c9f4", "89a920d03f202d9e29d959017ecc28c5");
